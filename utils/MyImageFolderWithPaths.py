...
class Cub2011(Dataset):
    ...
    url = 'file://./input/CUB_200_2011.tgz'
    filename = 'CUB_200_2011.tgz'
    tgz_md5 = '97eceeb196236b17998738112f37df78'


    def __init__(self, root = './input', train=True, transform=None, loader=default_loader, download=True):
    ...
    def index2classlist(self):
        ...
        list : index of list coresponding to classname
        """
        dir = os.path.join(self.root, self.base_folder)
        classes_list = [d for d in os.listdir(dir) if os.path.isdir(os.path.join(dir, d))]
